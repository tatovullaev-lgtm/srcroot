...
struct L1Branch
{
    ...
    void SetLength(unsigned char Length) { Quality += -(Quality >> 12) + (Length << 12); }

    static bool compareChi2(const L1Branch& a, const L1Branch& b) { return (a.Quality > b.Quality); }
    static bool comparePChi2(const L1Branch* a, const L1Branch* b) { return compareChi2(*a, *b); }
