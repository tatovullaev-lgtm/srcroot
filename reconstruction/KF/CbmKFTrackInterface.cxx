...
Int_t CbmKFTrackInterface::Extrapolate( Double_t z_out, Double_t *QP0 , Bool_t line ){
  ...
  //AZ-251123 if(z_out<400 && !line){ //GP
if(!line){ //AZ-251123
...
Int_t CbmKFTrackInterface::Fit( Bool_t downstream, Bool_t line )
{
  CbmKF *KF = CbmKF::Instance();
  Double_t *T = GetTrack();
...
Int_t CbmKFTrackInterface::Propagate( Double_t z_out, Double_t QP0 , Bool_t line){
  return CbmKF::Instance()->Propagate( GetTrack(), GetCovMatrix(), z_out, QP0, line );
}

Int_t CbmKFTrackInterface::Propagate( Double_t z_out, Bool_t line){
  return Propagate( z_out, GetTrack()[4], line );
}
