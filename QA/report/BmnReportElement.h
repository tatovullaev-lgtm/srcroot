 ...
 *
 */
class BmnReportElement : public TObject
{
public:
   /**
    * \brief Constructor.
   ...
   ClassDef(BmnReportElement, 1)
};

#endif /* BmnREPORTELEMENT_H_ */
