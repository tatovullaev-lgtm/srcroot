...
MACRO (WRITE_CONFIG_FILE filename)
  ...
  If (INSTALL_TRUE)
    ...
    SET(_EXECDIR ${CMAKE_INSTALL_PREFIX})
...
config.sh script to bypass this security issue.\"")
  ...
  IF(CMAKE_SYSTEM_NAME MATCHES Linux)
    ...
    EXECUTE_PROCESS(COMMAND bash "-c" "source ${CMAKE_CURRENT_BINARY_DIR}/check_system.sh define_system"
...
#  Set(VMCWORKDIR ${C})
  ...
  #SET (PATH ${ROOTSYS}/bin ${PATH}) #KG
  SET (PATH ${_BINDIR}/bin ${ROOTSYS}/bin ${PATH}) #KG
  UNIQUE(PATH "${PATH}")
  ...
  If (INSTALL_TRUE)
    string(REPLACE "${PROJECT_SOURCE_DIR}" "${VMCWORKDIR}" DBL_FILE_PATH $ENV{DBL_FILE_PATH})
  Else (INSTALL_TRUE)
    set(DBL_FILE_PATH $ENV{DBL_FILE_PATH})
  EndIf (INSTALL_TRUE)
  file(APPEND ${CMAKE_CURRENT_BINARY_DIR}/${filename} "export DBL_FILE_PATH=\"${DBL_FILE_PATH}\"\n")
  get_filename_component(GEOMETRY_DATABASE_DIR ${DBL_FILE_PATH} DIRECTORY)
  file(APPEND ${CMAKE_CURRENT_BINARY_DIR}/${filename} "export GEOMPATH=\"${GEOMETRY_DATABASE_DIR}/storage/\"\n")
