...
class CbmStsHit : public CbmHit
{
  ...
  **/
  ...
  Double_t GetStrip(int side)         const { return fStrips[side]; } //AZ-140223
  ...
  void SetStrips(Double_t s1, Double_t s2) { fStrips[0] = s1; fStrips[1] = s2; } //AZ-140223
 ...
 private:
  ...
  Double32_t fStrips[2]; //AZ-140223 - strip numbers (COGs of two views)
