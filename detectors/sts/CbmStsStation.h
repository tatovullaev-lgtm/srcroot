...
class CbmStsStation : public TNamed
{
  public:
    ...
    Int_t GetSystemId() const { return ((fDetectorId & (15 << 24)) >> 24); }
    Int_t GetStationNr() const { return ((fDetectorId & (255 << 16)) >> 16); }
    ...
    CbmStsSector* GetSector(Int_t iSector) { return (CbmStsSector*)fSectors->At(iSector); }
    ...
    Int_t GetNofZ();
    void SetZ(Double_t z) { fZ = fSensorZ[0] = z; }   // AZ-210625
