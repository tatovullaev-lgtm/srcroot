...
void BmnSiliconLayer::InitializeLayer() {
    ...
    BmnSiliconLayer::fUniqueIdL = 0;
    BmnSiliconLayer::fUniqueIdU = 0;
}
...
void BmnSiliconLayer::SetLayerSizes(Double_t xsize, Double_t ysize, Double_t xorig, Double_t yorig) {
    XMinLayer = xorig;
    XMaxLayer = xorig + xsize;
    YMinLayer = yorig;
    YMaxLayer = yorig + ysize;
...
void BmnSiliconLayer::SetAngleDeg(Double_t deg) {
    if(Abs(deg) <= 90.0) {
        ...
        AngleDeg = 0.0;
        if(Verbosity) cerr << "WARNING: BmnSiliconLayer::SetAngleDeg(): the strip angle is incorrect and has been set to zero\n";
    }
...
Bool_t BmnSiliconLayer::SetStripNumberingBorders(Double_t x_left, Double_t y_left, Double_t x_right, Double_t y_right) {
...
Bool_t BmnSiliconLayer::SetStripNumberingBorders(StripBorderPoint left, StripBorderPoint right) {
...
Bool_t BmnSiliconLayer::AddDeadZone(Int_t n_points, Double_t *x_points, Double_t *y_points) {
...
Bool_t BmnSiliconLayer::IsPointInsideDeadZones(Double_t x, Double_t y) {
...
Bool_t BmnSiliconLayer::IsPointInsideStripLayer(Double_t x, Double_t y) {
...
Double_t BmnSiliconLayer::ConvertNormalPointToStripY(Double_t x, Double_t y) {
    Double_t XRotationCenter;
    Double_t YRotationCenter;
...
Double_t BmnSiliconLayer::ConvertPointToStripPosition(Double_t x, Double_t y) {
...
void BmnSiliconLayer::FindClustersAndStripHits() {
 ...
 void BmnSiliconLayer::MakeStripHit(StripCluster &cluster, vector<Double_t> &AnalyzableStrips, Int_t &curcnt) {
...
//
 ...
 void BmnSiliconLayer::SmoothStripSignal(vector<Double_t>& AnalyzableStrips, Int_t NIterations, Int_t SmoothWindow, Double_t Weight) {
