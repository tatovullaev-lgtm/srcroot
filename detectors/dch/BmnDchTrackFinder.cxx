...
fPeriod(period), fRunId(number), expData(isExp) {
  ...
  hNomin1 = new TH1F("hNomin1"," eff nominator dc1", 9,0,9);
  hDenom1 = new TH1F("hDenom1"," eff denominator dc1", 9,0,9); 
  hNomin2 = new TH1F("hNomin2"," eff nominator dc2", 9,0,9);
  hDenom2 = new TH1F("hDenom2"," eff denominator dc2", 9,0,9);

  hEff1 = new TH1F("hEff1"," eff dc1", 9,0,9);
  hEff2 = new TH1F("hEff2"," eff dc2", 9,0,9);
  //    hNomin1->Sumw2();
  //hDenom1->Sumw2();
  //hNomin2->Sumw2();
  //hDenom2->Sumw2();
  ...
  h_pdg1 =  new TH1F("h_pdg1","dc1 seg pdg id",300,-10,290);
  h_pdg2 =  new TH1F("h_pdg2","dc2 seg pdg id",300,-10,290);
  h_pdgG =  new TH1F("h_pdgG","dcG seg pdg id",300,-10,290);
  ...
  hXDC1_atZ0F = new TH1F("hXDC1_atZ0F"," XDC1 extrapol Z = 0 final", 300,-100,200);
  hYDC1_atZ0F = new TH1F("hYDC1_atZ0F"," YDC1 extrapol Z = 0 final", 200,-100,100);
  hXDC2_atZ0F = new TH1F("hXDC2_atZ0F"," XDC2 extrapol Z = 0 final", 300,-100,200);
  hYDC2_atZ0F = new TH1F("hYDC2_atZ0F"," YDC2 extrapol Z = 0 final", 200,-100,100);

hXDCgl_atZ0 = new TH1F("hXDCgl_atZ0"," XDC global extrapol Z = 0 while matching", 200,-100,100);
hYDCgl_atZ0 = new TH1F("hYDCgl_atZ0"," YDC global extrapol Z = 0 while matching", 200,-100,100);

hYDCgl_atZ0F = new TH1F("hYDCgl_atZ0F"," YDC global extrapol Z = 0 after matching", 200,-100,100);
  ...
  hSlot_1ya_time = new TH1F("hSlot_1ya_time", "times_for_plane_DC1_ya", 2000,0,2000);
  hSlot_1yb_time = new TH1F("hSlot_1yb_time", "times_for_plane_DC1_yb", 2000,0,2000);
  hSlot_1ua_time = new TH1F("hSlot_1ua_time", "times_for_plane_DC1_ua", 2000,0,2000);
  hSlot_1ub_time = new TH1F("hSlot_1ub_time", "times_for_plane_DC1_ub", 2000,0,2000);
  hSlot_1va_time = new TH1F("hSlot_1va_time", "times_for_plane_DC1_va", 2000,0,2000);
  hSlot_1vb_time = new TH1F("hSlot_1vb_time", "times_for_plane_DC1_vb", 2000,0,2000);
  hSlot_2xa_time = new TH1F("hSlot_2xa_time", "times_for_plane_DC2_xa", 2000,0,2000);
  hSlot_2xb_time = new TH1F("hSlot_2xb_time", "times_for_plane_DC2_xb", 2000,0,2000);
  hSlot_2ya_time = new TH1F("hSlot_2ya_time", "times_for_plane_DC2_ya", 2000,0,2000);
  hSlot_2yb_time = new TH1F("hSlot_2yb_time", "times_for_plane_DC2_yb", 2000,0,2000);
  hSlot_2ua_time = new TH1F("hSlot_2ua_time", "times_for_plane_DC2_ua", 2000,0,2000);
  hSlot_2ub_time = new TH1F("hSlot_2ub_time", "times_for_plane_DC2_ub", 2000,0,2000);
  hSlot_2va_time = new TH1F("hSlot_2va_time", "times_for_plane_DC2_va", 2000,0,2000);
  hSlot_2vb_time = new TH1F("hSlot_2vb_time", "times_for_plane_DC2_vb", 2000,0,2000);
  ...
  hXvsAx1 = new TH2F("hXvsAx1", " X coord of a seg in dc1 vs x slope",  240, -0.1, .3, 240, -120, 120);
 hXvsAx2 = new TH2F("hXvsAx2", " X coord of a seg in dc2 vs x slope", 240, -0.1, .3, 240, -120, 120);
  ...
  hP = new TH1F("hP"," momentum = .3*Int(BL)/[sin(alphaX_out-alphaX_in)+C]", 300,0,15);
...
fhList.Add(hSlot_1xa_time);
  ...
  fhList.Add(hSlot_1ya_time);
  fhList.Add(hSlot_1yb_time);
  fhList.Add(hSlot_1ua_time);
  fhList.Add(hSlot_1ub_time);
  fhList.Add(hSlot_1va_time);
  fhList.Add(hSlot_1vb_time);
  fhList.Add(hSlot_2xa_time);
  fhList.Add(hSlot_2xb_time);
  fhList.Add(hSlot_2ya_time);
  fhList.Add(hSlot_2yb_time);
  fhList.Add(hSlot_2ua_time);
  fhList.Add(hSlot_2ub_time);
  fhList.Add(hSlot_2va_time);
  fhList.Add(hSlot_2vb_time);
  ...
  fhList.Add(hXDC1_atZ0F);
  fhList.Add(hYDC1_atZ0F);
  fhList.Add(hXDC2_atZ0F);
  fhList.Add(hYDC2_atZ0F);
fhList.Add(hXDCgl_atZ0);
fhList.Add(hYDCgl_atZ0);
fhList.Add(hYDCgl_atZ0F);
 ...
 //end
  ...
  // Some alignment corrections
   if(fPeriod == 8){
     ...
     x1_sh =12.20;//run 7 GEM 11.26;//run8 beam 12.20;//run8 -1.03;//10.3;//0;       //11.2;//-8.56;//run6 10.9;// 5.34;//5.14;//10.31; //
     y1_sh =.32;//run 7 GEM -2.92;//run8 beam .32;//run8 0;//-3;//0;       //1.76;//5.76;//run6 -1.19;//0;//-1.03;
     x2_sh =6.74;//run 7 GEM 11.86-5.99;//run8 beam 6.74;//run9 test-7.41-.13-.04;//-3.69+0.05+1.7;//run8 -5.99;;//-5.4;//4.7;//8.60; //9.-3.5;//0.0;//run6 5.56;//0;//7.95;// //
     y2_sh = 0;//run 7 GEM-.24 - 2.81;///run8 beam 0;//run8 -.24;//-.47;//-3.3;//-12.40;  //1.8;//-7.1;//run6 -2.47;//-1.38;//-3.7;
    
    x1_slope_sh = 0.0034;//run 7 GEM  0.003;//run8 beam 0.0034;//run9 test -0.008+0.0005;//0.0115+0.0085;//run8 0.0059;//-.070;//0;
    y1_slope_sh = -0.0014;//run 7 GEM0;//run8 beam -0.0014;//run9 test 0;//run8 0;//.060;//0;
    x2_slope_sh = -0.0024+0.0001;//run 7 GEM0.003-0.005;//run8 beam -0.0024+0.0001;//run9 test-0.017+0.005+0.0005-.0009;//0.007+0.0085;//run8 0.0009;//-.005;//-.034;//-.071;//0.;
    y2_slope_sh = 0.0040;//run 7 GEM0.005; //run8 beam 0.0040;//run9 test0.005;//run8 0.005;//.005;//.014;//.061;//0.007;
     }
     cout<<"alignment on"<<endl;
...
void BmnDchTrackFinder::Exec(Option_t* opt) {
  ...
  if (expData) {
	...
	continue;
      //                 cout<<" plane "<<plane<<" wire "<<wire<<" time "<<time<<endl;
      wires[plane][it[plane]] = wire;
      driftLength[plane][it[plane]] = time;

      it[plane]++;
  if (plane == 1){
	hVa_wireOccupancy->Fill(wire);
	hSlot_1va_time->Fill(time);      
      }
      if (plane == 0){
	hVb_wireOccupancy->Fill(wire);
	hSlot_1vb_time->Fill(time);
      }
      
      if (plane == 3){
	hUa_wireOccupancy->Fill(wire);
	hSlot_1ua_time->Fill(time);
      }
      if (plane == 2){
	hUb_wireOccupancy->Fill(wire);
	hSlot_1ub_time->Fill(time);
      }
      if (plane == 5){
	hYa_wireOccupancy->Fill(wire);
	hSlot_1ya_time->Fill(time);
      }
      if (plane == 4){
	hYb_wireOccupancy->Fill(wire);
	hSlot_1yb_time->Fill(time);
      }
      if (plane == 7){
	hXa_wireOccupancy->Fill(wire);
	hSlot_1xa_time->Fill(time);
      }
      if (plane == 6){
	hXb_wireOccupancy->Fill(wire);
	hSlot_1xb_time->Fill(time);
      }
      if (plane == 9) {
	hVa2_wireOccupancy->Fill(wire);
	hSlot_2va_time->Fill(time);
      }
      if (plane == 8) {
	hVb2_wireOccupancy->Fill(wire);
	hSlot_2vb_time->Fill(time);
      }
      if (plane == 11) {
	hUa2_wireOccupancy->Fill(wire);
	hSlot_2ua_time->Fill(time);
      }
      if (plane == 10){
	hUb2_wireOccupancy->Fill(wire);
	hSlot_2ub_time->Fill(time);
      }
      if (plane == 13){
	hYa2_wireOccupancy->Fill(wire);
	hSlot_2ya_time->Fill(time);
      }
      if (plane == 12) {
	hYb2_wireOccupancy->Fill(wire);
	hSlot_2yb_time->Fill(time);
      }
      if (plane == 15) {
	hXa2_wireOccupancy->Fill(wire);
	hSlot_2xa_time->Fill(time);
      }
      if (plane == 14) {
	hXb2_wireOccupancy->Fill(wire);
	hSlot_2xb_time->Fill(time);
      } 
    ...
    for (Int_t iMC = 0; iMC < fBmnHitsArray->GetEntriesFast(); ++iMC) {
      ...
      //      cout<<" plane "<<plane<<" wire "<<wire<<" ~coord "<<wire-119<<" dist "<<time<<endl;
...
void BmnDchTrackFinder::SegmentsToBeMatched() {
 ...
 while (true) {
	...
	Double_t YDCgl_atZ0 = ay*(-Z_dch_mid - 645)+yMean;
	//	cout<<" yv at matching cut "<<yV<<endl;
	if ((segment_size[0][segdc1Nr] + segment_size[1][segdc2Nr]) < 12) continue;
	//	if (fabs(dx) > 20. || fabs(dy) > 20. || fabs(daX) > 0.25 || fabs(daY) > 0.25 || fabs(YDCgl_atZ0+3.3)>12) continue;
	...
	//	cout<<" yv iside the cut "<<yV<<endl;
	hYDCgl_atZ0 ->Fill(ay*(-Z_dch_mid - 645)+yMean);
	hXDCgl_atZ0 ->Fill(ax*(-Z_dch_mid +249 )+xMean);
	//	if((ay*(-Z_dch_mid-645)+yMean +4.5) < -10 || (ay*(-Z_dch_mid-645)+yMean+4.5) > 10)continue;
    ...
    x_mid[nSegmentsToBeMatched] = 0.5 * (params[1][1][best2] + params[0][1][best1]);//(x_global[0][best1] + x_global[1][best2]);  //par_ab1[1][best1];//xDC1_glob[best1];//xMean;
    y_mid[nSegmentsToBeMatched] = 0.5 * (params[1][3][best2] + params[0][3][best1]);//(y_global[0][best1] + y_global[1][best2]);  //yDC1_glob[best1];//yMean;
    ...
    //        cout<<" match x "<<x_mid[nSegmentsToBeMatched]<<" y "<<y_mid[nSegmentsToBeMatched]<<" dc1 "<<best1<<" dc2 "<<best2<<endl;
    ...
    // float intBL = 2.84;//1800A 813
     // hP->Fill(0.3*intBL/(atan(aX[nSegmentsToBeMatched]))); 
    ...
    if(best_pair){
      best_pair = false;
       if(segsDC1 ==1){
    for(int k = 0; k<8; k++){
      if( segment_size[0][best1] == 6 && rh_segment[0][k][best1] == -999) {hDenom1->Fill(k,1);hDenom1->Fill(8,1);}
      if( segment_size[0][best1] != 6){
	if(rh_segment[0][k][best1] == -999){
	  hDenom1->Fill(k,1);
	  hDenom1->Fill(8,1);
	}else{
	  hNomin1->Fill(k,1);
 ...
 if(segsDC2 ==1){
    for(int k2 = 0; k2<8; k2++){
      if( segment_size[1][best2] == 6 && rh_segment[1][k2][best2] == -999) {
	hDenom2->Fill(k2,1);
	hDenom2->Fill(8,1);
      }
      if( segment_size[1][best2] != 6){
	if(rh_segment[1][k2][best2] == -999){
	  hDenom2->Fill(k2,1);
	  hDenom2->Fill(8,1);
 ...
 if(segsDC1 >1){
    for(int k = 0; k<8; k++){
      if( segment_size[0][yVbest1] == 6 && rh_segment[0][k][yVbest1] == -999) hDenom1->Fill(k,1);
      if( segment_size[0][yVbest1] != 6){
	if(rh_segment[0][k][yVbest1] == -999){
	  hDenom1->Fill(k,1);
	}else{
	  hNomin1->Fill(k,1);
	  hDenom1->Fill(k,1);
 ...
 if(segsDC2 >1){
    for(int k2 = 0; k2<8; k2++){
      if( segment_size[1][yVbest2] == 6 && rh_segment[1][k2][yVbest2] == -999) hDenom2->Fill(k2,1);
      if( segment_size[1][yVbest2] != 6){
	if(rh_segment[1][k2][yVbest2] == -999){
	  hDenom2->Fill(k2,1);
	}else{
	  hNomin2->Fill(k2,1);
	  hDenom2->Fill(k2,1);
  ...
  for (Int_t i = 0; i < pairU; i++) {
   ...
   Double_t u_coord = (u_ab[0][i] + u_ab[1][i]) / 2;
	...
	if(dchID == 2){
     ...
     //  cout<<" current u a/b "<<u_ab[0][i]<<" "<<u_ab[1][i]<<" v a/b "<<v_ab[0][j]<<" "<<v_ab[1][j]<<" x est "<<x_est<<" y est "<<y_est<<endl;
	...
	if (foundX && !foundY) {
	  ...
	  for (Int_t kk = 0; kk < single_ya; kk++) {
	    //	    cout<<" ya single "<<y_single[0][kk]<<endl;
	  ...
	  for (Int_t kk = 0; kk < single_yb; kk++) {
	    // cout<<" yb single "<<y_single[0][kk]<<endl;
...
Bool_t BmnDchTrackFinder::FitDchSegments(Int_t dchID, Int_t* size_seg, Double_t** rh_seg, Double_t** rh_sigm_seg, Double_t** par_ab, Double_t* chi2, Double_t* x_glob, Double_t* y_glob) {
  ...
  for (Int_t j = 0; j < nDC_segments; j++) {
    ...
    Double_t _par_ab[4];
    //          cout<<" before V cut in dc "<< dchID<<" seg "<<j<<" ";
    ...
    if(dchID == 1){
      hXDC1_atZ0 ->Fill(par_ab[0][j]*(-Z_dch+249)+par_ab[1][j]);//645 - z target SRC, 249 z M_out
      hYDC1_atZ0 ->Fill(par_ab[2][j]*(-Z_dch-645)+par_ab[3][j]);
    }else{
      hXDC2_atZ0 ->Fill(par_ab[0][j]*(-Z_dch+249)+par_ab[1][j]);
      hYDC2_atZ0 ->Fill(par_ab[2][j]*(-Z_dch-645)+par_ab[3][j]);
    }
    //cut on x0 and y0 at back of the magnet
     if(expData){
       //     cout<<" dc "<<dchID<<" seg id "<<j<<" y at z=0 "<<(par_ab[2][j]*(-Z_dch-645)+par_ab[3][j] +4.5)<<" x at magnet "<<(par_ab[0][j]*(-Z_dch+249)+par_ab[1][j])<<" chi "<<chi2[j]<<endl;
     if(dchID == 1){
          if((par_ab[2][j]*(-Z_dch-645)+par_ab[3][j] +4.5) < -50 || (par_ab[2][j]*(-Z_dch-645)+par_ab[3][j]+4.5) > 50 || (par_ab[0][j]*(-Z_dch+249)+par_ab[1][j]) < -85 || (par_ab[0][j]*(-Z_dch+249)+par_ab[1][j]) > 85){
       	chi2[j] = 999;
        }
    }else{
    	if((par_ab[2][j]*(-Z_dch-645)+par_ab[3][j] +4.5) < -55 || (par_ab[2][j]*(-Z_dch-645)+par_ab[3][j]+4.5) > 55 || (par_ab[0][j]*(-Z_dch+249)+par_ab[1][j]) < -85 || (par_ab[0][j]*(-Z_dch+249)+par_ab[1][j]) > 85){
      chi2[j] = 999;
        }
     }
     }
...
void BmnDchTrackFinder::CreateDchTrack(Int_t dchID, Double_t* chi2Arr, Double_t** parArr, Int_t* sizeArr, Double_t** rh_seg, Double_t** rh_seg_time, Double_t** sigm_seg_par, Int_t* SegMC_Id, Int_t* SegMC_IdCount) {
  ...
  for (Int_t iSegment = 0; iSegment < nDC_segments; iSegment++) {
    ...
    //            cout<<" dc "<<dchID<<" seg id "<<iSegment<<" x "<<-parArr[1][iSegment]<<" ax "<<-parArr[0][iSegment]<<" y "<<parArr[3][iSegment]<<" ay "<<parArr[2][iSegment]<<" size "<<sizeArr[iSegment]<<endl;
    ...
    if (dchID == 1) {//	hXDCgl_atZ0 ->Fill(ax*(-Z_dch_mid +249 )+xMean);
      hXDC1_atZ0F ->Fill(-parArr[0][iSegment]*(-z0 -645)-parArr[1][iSegment]);
      hYDC1_atZ0F ->Fill(parArr[2][iSegment]*(-z0 -645)+parArr[3][iSegment]);
      h_pdg1->Fill(SegMC_Id[iSegment]);
      ...
      hXvsAx1->Fill(-parArr[0][iSegment],parArr[1][iSegment]);
	...
	if( sizeArr[iSegment] != 6){
      ...
      */
      ...
      hXDC2_atZ0F ->Fill(-parArr[0][iSegment]*(-z0-645)-parArr[1][iSegment]);
      hYDC2_atZ0F ->Fill(parArr[2][iSegment]*(-z0-645)+parArr[3][iSegment]);
      h_pdg2->Fill(SegMC_Id[iSegment]);
      ...
      hXvsAx2->Fill(-parArr[0][iSegment],parArr[1][iSegment]);
  ...
  if(dchID == 1  && best_seg1 != -1){
    ...
    /*  if(good_dc_segs == 1){
    for(int k = 0; k<8; k++){
      if( sizeArr[best_seg1] == 6 && rh_seg[k][best_seg1] == -999) hDenom1->Fill(k,1);
      if( sizeArr[best_seg1] != 6){
	if(rh_seg[k][best_seg1] == -999){
	  hDenom1->Fill(k,1);
	}else{
	  hNomin1->Fill(k,1);
	  hDenom1->Fill(k,1);
  ...
  if(dchID == 2 && best_seg1 != -1){
    ...
    /* if(good_dc_segs == 1){
      for(int k = 0; k<8; k++){
	if( sizeArr[best_seg1] == 6 && rh_seg[k][best_seg1] == -999) hDenom2->Fill(k,1);
	if( sizeArr[best_seg1] != 6){
	  if(rh_seg[k][best_seg1] == -999){
	    hDenom2->Fill(k,1);
	  }else{
...
void BmnDchTrackFinder::CreateDchTrack() {
  ...
  for (Int_t iSeg = 0; iSeg < nSegmentsToBeMatched + 1; iSeg++) {
    ...
    //    cout<<" create x "<<x0<<" y "<<y0<<endl;
    //set of field integrals to choose from
    //     float intBL = 0.471;//300A  818                                                                                                                                                                                                                            
    //   float intBL = 0.984;//600A  818
    //   float intBL = 1.455;//900A 816 817
    // float intBL = 2.725;//1750A
    //  float intBL = 1.93;//1200A 815
    ...
    // float intBL = 3.38;//2100A
    // float intBL = 2.55;//1600A 814 834
     float intBL = 2.63;//1650A 814 834
    // float intBL = 2.84;//1800A 813
  hP->Fill(0.3*intBL/(atan(aX[iSeg])));
    ...
    track->SetParamFirst(trackParam);
    track->SetB(0.3*intBL/(atan(aX[iSeg])));
      hYDCgl_atZ0F ->Fill(aY[iSeg]*(-z0 - 645)+y0);
...
Int_t BmnDchTrackFinder::Reconstruction(Int_t dchID, TString wire, Int_t pair, Int_t it_a, Int_t it_b,
  ...
  for (Int_t i = 0; i < it_a; ++i)
	...
	for (Int_t m = 0; m < 2; m++){
      ...
      //              cout<<" plane "<<wire<<" da "<<d_a<<" db "<<d_b<<" a1 "<<a_coord1<<" b1 "<<b_coord1<<" a2 "<<a_coord2<<" b2 "<<b_coord2<<endl;
...
Int_t BmnDchTrackFinder::ReconstructionMC(Int_t dchID, TString wire, Int_t pair, Int_t it_b, Int_t it_a,
  ...
  for (Int_t i = 0; i < it_a; ++i)
	...
	if (arrIdxShift == 8) hy2Da_Db->Fill(d_a + d_b - .5);
      ...
      //             cout<<" a1 "<<a_coord1<<" b1 "<<b_coord1<<" a2 "<<a_coord2<<" b2 "<<b_coord2<<endl;
      CompareDaDb(d_a, sigm_ab[0][pair]);
      CompareDaDb(d_b, sigm_ab[1][pair]);
      CompareDaDb(d_a, sigm_ab[0][pair+1]);
      CompareDaDb(d_b, sigm_ab[1][pair+1]);
...
Int_t BmnDchTrackFinder::ReconstructionSingleMC(Int_t dchID, TString wire, TString lay, Int_t single, Int_t it,
  ...
  for (Int_t i = 0; i < it; ++i) {
    ...
    CompareDaDb(d, sigm_single[0 + arrIdx1][single], sigm_single[0 + arrIdx1][single + 1]);
    //     cout<<" single 1/2 "<<_single[0 + arrIdx1][single]<<" / "<<_single[0 + arrIdx1][single+1]<<endl;
