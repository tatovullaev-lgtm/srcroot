/** @file BmnSsdSensorPoint.h
 ** @author Volker Friese <v.friese@gsi.de>
 ** @author D. Baranov
 ** @date 20.12.2018
 **/

#ifndef BMNSSDSENSORPOINT_H
#define BMNSSDSENSORPOINT_H 1

#include <string>
#include "Rtypes.h"

/** @class BmnSsdSensorPoint
 ** @brief Container class for a local point in a SSD sensor
 ** @version 1.0
 **
...
class BmnSsdSensorPoint
{
  ...
  public:
     ...
     **/
    BmnSsdSensorPoint(Double_t x1, Double_t y1, Double_t z1,
  ...
  private:
    ...
    ClassDef(BmnSsdSensorPoint,2);

};

#endif /* BMNSSDSENSORPOINT_H */
