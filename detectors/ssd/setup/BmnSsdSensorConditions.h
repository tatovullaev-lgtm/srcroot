/** @file BmnSsdSensorConditions.h
 ** @author Volker Friese <v.friese@gsi.de>
 ** @author D. Baranov
 ** @date 13.12.2018
 **/

#ifndef BMNSSDSENSORCONDITIONS_H
#define BMNSSDSENSORCONDITIONS_H 1

#include <string>
#include "TMath.h"
#include "TObject.h"

/** @class BmnSsdSensorConditions
 ** @brief Container for operating condition parameters of a sensor
 ** @since 13.12.2018
 ** @version 1.0
 **/
class BmnSsdSensorConditions : public TObject {
	...
	public:
		 ...
		 **/
		BmnSsdSensorConditions(Double_t vFD = 0., Double_t vBias = 0.,
	...
	private:
		...
		ClassDef(BmnSsdSensorConditions, 1);
};

#endif /* BMNSSDSENSORCONDITIONS_H */
