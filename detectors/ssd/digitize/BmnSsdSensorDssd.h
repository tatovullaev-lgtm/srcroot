/** @file BmnSsdSensorDssd.h
 ** @author Volker Friese <v.friese@gsi.de>
 ** @author D. Baranov
 ** @date 19.12.2018
 **/

#ifndef BMNSSDSENSORDSSD_H
#define BMNSSDSENSORDSSD_H 1
 ...
 ** channel of the readout module (BmnSsdModule).
 **
 ...
 **/
class BmnSsdSensorDssd : public BmnSsdSensor
{
  ...
  public:
     ...
     **/
    BmnSsdSensorDssd(Int_t address = 0, TGeoPhysicalNode* node = nullptr,
     ...
     ** @param clusters Input vector of SsdClusters in the module
     ** @param dTime    Max. time difference for two clusters to make a hit
     ** @value Number of found hits in this sensor
     **
  ...
  protected:
     ...
     ** @param point  Pointer to BmnSsdSensorPoint object
     ...
     ** type BmnSsdSensorPoint, giving the geometric intersection of the
     ...
     **/
    virtual Int_t IntersectClusters(BmnSsdCluster* clusterF,
                                    BmnSsdCluster* clusterB) = 0;
  ...
  private:
    ...
    BmnSsdSensorDssd(BmnSsdSensorDssd& rhs) = delete;


    /** Forbid assignment operator **/
    BmnSsdSensorDssd& operator = (const BmnSsdSensorDssd& rhs) = delete;



    ClassDef(BmnSsdSensorDssd,1);
