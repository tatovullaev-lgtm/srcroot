...
BmnSsdPhysics* BmnSsdPhysics::fgInstance    = NULL;
const Double_t BmnSsdPhysics::fgkSiCharge   = 14.;
const Double_t BmnSsdPhysics::fgkSiDensity  = 2.336;        // g/cm^3
const Double_t BmnSsdPhysics::fgkProtonMass = 0.938272081;  // GeV
// -------------------------------------------------------------------------



// -----   Constructor   ---------------------------------------------------
BmnSsdPhysics::BmnSsdPhysics()
	: fUrbanI(0.),
	  fUrbanE1(0.),
	  fUrbanE2(0.),
	  fUrbanF1(0.),
...
// -----   Diffusion width   -----------------------------------------------
Double_t BmnSsdPhysics::DiffusionWidth(Double_t z, Double_t d,
	...
	// For the formula, see the SSD digitiser note.
	Double_t tau = 0.;
...
// -----   Electric field   ------------------------------------------------
Double_t BmnSsdPhysics::ElectricField(Double_t vBias, Double_t vFd,
...
Double_t BmnSsdPhysics::EnergyLoss(Double_t dz, Double_t mass, Double_t eKin,
		                               Double_t dedx) const {
...
// ----- Get static instance   ---------------------------------------------
BmnSsdPhysics* BmnSsdPhysics::Instance() {
	  if ( ! fgInstance ) fgInstance = new BmnSsdPhysics();
	  return fgInstance;
}
// -------------------------------------------------------------------------
...
Double_t BmnSsdPhysics::InterpolateDataTable(Double_t eEquiv,
...
Double_t BmnSsdPhysics::ParticleCharge(Int_t pid) {
...
Double_t BmnSsdPhysics::ParticleMass(Int_t pid) {
...
void BmnSsdPhysics::ReadDataTablesLandauWidth() {

	// The table with errors for Landau distribution:
	// MP charge (e) --> half width of charge distribution (e)

	TString dir = gSystem->Getenv("VMCWORKDIR");
	TString errFileName = dir + "/parameters/ssd/LandauWidthTable.txt";
...
// -----   Read data tables for stopping power   ---------------------------
void BmnSsdPhysics::ReadDataTablesStoppingPower() {
	...
	TString dir = gSystem->Getenv("VMCWORKDIR");
	TString eFileName = dir + "/parameters/ssd/dEdx_Si_e.txt";
	TString pFileName = dir + "/parameters/ssd/dEdx_Si_p.txt";
...
void BmnSsdPhysics::SetUrbanParameters(Double_t z) {
...
// -----   Stopping power   ------------------------------------------------
Double_t BmnSsdPhysics::StoppingPower(Double_t eKin, Int_t pid) {
