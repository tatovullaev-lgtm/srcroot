/** @file BmnSsdSensorDssdStereo.h
 ** @author Volker Friese <v.friese@gsi.de>
 ** @author D. Baranov
 ** @date 20.12.2018
 **/

#ifndef BMNSSDSENSORDSSDSTEREO_H
#define BMNSSDSENSORDSSDSTEREO_H 1
 ...
 **/
class BmnSsdSensorDssdStereo : public BmnSsdSensorDssd
{
  ...
  public:
     ...
     **/
    BmnSsdSensorDssdStereo(UInt_t address = 0, TGeoPhysicalNode* node = nullptr,
     ...
     **/
    BmnSsdSensorDssdStereo(Double_t dy, Int_t nStrips, Double_t pitch,
  ...
  private:
    ...
    BmnSsdSensorDssdStereo(BmnSsdSensorDssdStereo& rhs);


    /** Assignment operator (not implemented)  **/
    BmnSsdSensorDssdStereo& operator = (const BmnSsdSensorDssdStereo& rhs);



    ClassDef(BmnSsdSensorDssdStereo,1);
