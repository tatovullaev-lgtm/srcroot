...
class BmnFD : public FairDetector
{
 ...
 public:
  ...
  virtual void ConstructGeometry();
	...
	BmnFDPoint* AddHit(Int_t trackID, Int_t detID,  Int_t copyNo, 
 ...
 private:
  ...
  Float_t        fLightYield;
  TClonesArray*  fFDCollection;        //! Hit collection
...
//------------------------------------------------------------------------------------------------------------------------
inline void BmnFD::ResetParameters() 
{
