#ifndef BMNSiProfMODULE_H
#define	BMNSiProfMODULE_H
...
public:
    ...
    BmnSiProfLayer& GetStripLayer(Int_t num) { return StripLayers.at(num); }
    vector<BmnSiProfLayer>& GetStripLayers() { return StripLayers; }
...
private:
    BmnSiProfModule(const BmnSiProfModule&) = delete;
    BmnSiProfModule& operator=(const BmnSiProfModule&) = delete;
...
private:
    ...
    vector<BmnSiProfLayer> StripLayers;
