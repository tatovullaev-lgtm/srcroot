...
class BmnSiProf : public FairDetector {
...
public:
    ...
    // active volume. Creates BmnSiProfPoints and adds them to the collection.
    ...
    // Constructs the SiProf geometry
...
private:
    ...
    // Adds a BmnSiProfPoint to the HitCollection
    BmnSiProfPoint* AddHit(Int_t trackID, Int_t detID,
    ...
    BmnSiProf(const BmnSiProf&) = delete;
    BmnSiProf operator=(const BmnSiProf&) = delete;

    ClassDef(BmnSiProf,1)
};

//------------------------------------------------------------------------------
inline void BmnSiProf::ResetParameters() {
    fTrackID = -1;
    fVolumeID = 0;
