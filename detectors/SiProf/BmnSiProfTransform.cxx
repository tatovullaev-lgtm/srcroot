...
void BmnSiProfTransform::PrintTest() {
...
void BmnSiProfTransform::Reset() {
    transform_stack.clear();
}

Bool_t BmnSiProfTransform::LoadFromXMLFile(TString xml_config_file) {
    ...
    if(parse_status != 0) {
        std::cerr << "Error: An error occured when parsing the file! (in BmnSiProfTransform)\n";
        return false;
    }
...
Plane3D::Point BmnSiProfTransform::ApplyTransforms(Plane3D::Point point, Int_t station, Int_t module) {
...
Plane3D::Point BmnSiProfTransform::ApplyInverseTransforms(Plane3D::Point point, Int_t station, Int_t module) {
    Plane3D::Point tpoint = point; //transformed point
