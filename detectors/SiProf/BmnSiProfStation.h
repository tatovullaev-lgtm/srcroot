#ifndef BMNSiProfSTATION_H
#define	BMNSiProfSTATION_H
...
protected:
    ...
    BmnSiProfModule **Modules; //modules in the station [array]
...
public:
    ...
    BmnSiProfStation(TXMLNode *stationNode, Int_t iStation,
