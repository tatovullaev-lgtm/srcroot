#ifndef BMNSiProfLAYER_H
#define	BMNSiProfLAYER_H
...
class BmnSiProfLayer {

public:
    //Constructors -------------------------------------------------------------
    BmnSiProfLayer();

    BmnSiProfLayer(Int_t zone_number, StripLayerType layer_type,
...
private:
    //BmnSiProfLayer(const BmnSiProfLayer&) = delete;
    //BmnSiProfLayer& operator=(const BmnSiProfLayer&) = delete;
...
private:
    ...
    Double_t Pitch;
    Double_t AngleDeg; //Angle between two sets of parallel strips: angle from vertical
    Double_t AngleRad;
