#ifndef BMNSiProfPOINT_H
#define BMNSiProfPOINT_H

#include "FairMCPoint.h"

class BmnSiProfPoint : public FairMCPoint {
...
public:
    ...
    **/
    BmnSiProfPoint(Int_t trackID, Int_t detID,
                TVector3 posIn, TVector3 posOut,
                TVector3 momIn, TVector3 momOut,
                Double_t tof, Double_t length, Double_t eLoss,
                Int_t isPrimary, Double_t charge, Int_t pdgId);

    BmnSiProfPoint(const BmnSiProfPoint& point) { *this = point; };
...
protected:
    ...
    Double_t fX_center,  fY_center,  fZ_center; //middle pos. (hit position)
    Double_t fPx_out, fPy_out, fPz_out;

    Int_t fStation;
    Int_t fModule;

    ClassDef(BmnSiProfPoint,1)
};

#endif /* BMNSiProfPOINT_H */
