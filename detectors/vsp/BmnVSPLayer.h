#ifndef BMNVSPLAYER_H
#define BMNVSPLAYER_H
...
private:
    //BmnVSPLayer(const BmnVSPLayer&) = delete;
    //BmnVSPLayer& operator=(const BmnVSPLayer&) = delete;
