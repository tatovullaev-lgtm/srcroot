...
BmnVSPTransform::BmnVSPTransform()
{}
...
void BmnVSPTransform::PrintTest()
{
...
void BmnVSPTransform::Reset() {
    transform_stack.clear();
}

Bool_t BmnVSPTransform::LoadFromXMLFile(TString xml_config_file) {
    ...
    if(parse_status != 0) {
        std::cerr << "Error: An error occured when parsing the file! (in BmnVSPTransform)\n";
        return false;
    }
...
Plane3D::Point BmnVSPTransform::ApplyTransforms(Plane3D::Point point, Int_t station, Int_t module) {
...
Plane3D::Point BmnVSPTransform::ApplyInverseTransforms(Plane3D::Point point, Int_t station, Int_t module) {
    Plane3D::Point tpoint = point; //transformed point
