#ifndef BMNVSPSTATIONSET_H
#define BMNVSPSTATIONSET_H
...
class BmnVSPStationSet
{
  protected:
    /* station set parameters*/
    Int_t NStations;   // number of stations in the VSP detector
    ...
    BmnVSPStation** VSPStations;         //[NStations] VSP stations [array]
  ...
  public:
    ...
    BmnVSPStation* GetStation(Int_t station_num) { return GetVSPStation(station_num); }
  ...
  private:
    ...
    ClassDef(BmnVSPStationSet, 1);
};

#endif /* BMNVSPSTATIONSET_H */
