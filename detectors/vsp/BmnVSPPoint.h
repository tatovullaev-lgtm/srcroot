#ifndef BMNVSPPOINT_H
#define BMNVSPPOINT_H

#include "FairMCPoint.h"

class BmnVSPPoint : public FairMCPoint
{
  public:
    ...
    **/
    BmnVSPPoint(Int_t trackID, Int_t detID,
                    TVector3 posIn, TVector3 posOut,
                    TVector3 momIn, TVector3 momOut,
                    Double_t tof, Double_t length, Double_t eLoss,
                    Int_t isPrimary, Double_t charge, Int_t pdgId);
    BmnVSPPoint(const BmnVSPPoint& point) { *this = point; };
    BmnVSPPoint();
