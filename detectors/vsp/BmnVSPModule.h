#ifndef BMNVSPMODULE_H
#define BMNVSPMODULE_H
...
public:
    ...
    BmnVSPLayer& GetStripLayer(Int_t num) { return StripLayers.at(num); }
    vector<BmnVSPLayer>& GetStripLayers() { return StripLayers; }
...
private:
    BmnVSPModule(const BmnVSPModule&) = delete;
    BmnVSPModule& operator=(const BmnVSPModule&) = delete;
...
private:
    ...
    vector<BmnVSPLayer> StripLayers;
