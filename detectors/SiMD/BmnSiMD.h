...
class BmnSiMD : public FairDetector
{
  public:
    /** Default constructor **/
    BmnSiMD();
    ...
    **/
    ...
    BmnSiMDPoint* AddHit(Int_t trackID, Int_t detID,  Int_t copyNo,
  ...
  private:
    ...
    Float_t         fLightYield;
    TClonesArray*   fSiMDCollection;      //! Hit collection
    ...
    BmnSiMD(const BmnSiMD&) = delete;
    BmnSiMD operator=(const BmnSiMD&) = delete;
...
//------------------------------------------------------------------------------------------------------------------------
inline void BmnSiMD::ResetParameters() 
{
