#ifndef BMNSiBTPOINT_H
#define BMNSiBTPOINT_H

#include "FairMCPoint.h"

class BmnSiBTPoint : public FairMCPoint
{
  public:
    BmnSiBTPoint();
    ...
    BmnSiBTPoint(const BmnSiBTPoint& point) { *this = point; };
  ...
  protected:
    ...
    ClassDef(BmnSiBTPoint, 1)
};

#endif /* BMNSiBTPOINT_H */
