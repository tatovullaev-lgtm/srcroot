#ifndef BMNSiBTLAYER_H
#define	BMNSiBTLAYER_H
...
public:
    ...
    BmnSiBTLayer(Int_t zone_number, StripLayerType layer_type,
...
private:
    //BmnSiBTLayer(const BmnSiBTLayer&) = delete;
    //BmnSiBTLayer& operator=(const BmnSiBTLayer&) = delete;
