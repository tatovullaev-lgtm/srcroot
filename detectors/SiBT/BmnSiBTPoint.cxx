...
BmnSiBTPoint::BmnSiBTPoint(Int_t trackID,
                           Int_t detID,
                           TVector3 posIn,
                           TVector3 posOut,
                           TVector3 momIn,
...
void BmnSiBTPoint::Print(const Option_t* opt) const
{
    cout << "-I- BmnSiBTPoint: SiBT point for track " << fTrackID << " in detector " << fDetectorID << endl;
