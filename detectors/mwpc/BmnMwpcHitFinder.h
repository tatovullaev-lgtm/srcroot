...
#include "TH1D.h"
#include "TH2D.h"
#include "../../base/header/DstEventHeader.h"
...
class BmnMwpcHitFinder : public FairTask {
  ...
  TH2D  *hYvsX_mc_ch2, *hYvsX_mc_ch3, *hfiredWireCh01, *hfiredWireCh23, *hfiredWireCh12;
  ...
  vector<TH1D*> hNp_best_Ch, hNbest_Ch, hOccupancy, hTime,
         ...
         hWiresXp, hWiresUp, hWiresVp, hWiresXm, hWiresUm, hWiresVm, hNclustCh,
         ...
         hdt_fastest_other_Ch,hdw_fastest_other_Ch, hsum_time_Ch;
         
  vector<TH2D*>   hEvent_display_Ch, htime_wire_Ch, hY_X_Ch, hdt_dwire_Ch, hClustSizePlCh;
  Int_t kMinHits;
