...
class BmnTof1HitProducerIdeal : public BmnTask
{
  protected:
    ...
    //!!!!!!!!!!!!!!!!!!!!!!! added 14.04.2025
    TClonesArray *aExpDigitsT0_3;  //! <--- Exp input for run8 SRC
    TClonesArray *aExpDigitsT0_4;  //! <--- Exp input for run8 SRC
    TClonesArray *aExpDigitsT0_5;  //! <--- Exp input for run8 SRC
    TClonesArray *aExpDigitsT0_6;  //! <--- Exp input for run8 SRC
    TClonesArray *aExpDigitsT0_7;  //! <--- Exp input for run8 SRC
    TClonesArray *aExpDigitsT0_8;  //! <--- Exp input for run8 SRC
    //!!!!!!!!!!!!!!!!!!!!!!!
  ...
  public:
    BmnTof1HitProducerIdeal(const char *name = "TOF1 Ideal HitProducer", Bool_t useMCdata = true, Int_t verbose = 1,
