...
public:
    ...
    // active volume. Creates BmnCSCPoints and adds them to the collection.
...
private:
    ...
    // Adds a BmnCSCPoint to the HitCollection
    BmnCSCPoint* AddHit(Int_t trackID, Int_t detID,
...
//------------------------------------------------------------------------------
inline void BmnCSC::ResetParameters() {
    fTrackID = -1;
    fVolumeID = 0;
