#ifndef BMNCSCMODULE_H
#define	BMNCSCMODULE_H
...
public:
    ...
    BmnCSCLayer& GetStripLayer(Int_t num) { return StripLayers.at(num); }
    vector<BmnCSCLayer>& GetStripLayers() { return StripLayers; }
...
private:
    ...
    vector<BmnCSCLayer> StripLayers;
