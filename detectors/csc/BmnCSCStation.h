#ifndef BMNCSCSTATION_H
#define	BMNCSCSTATION_H
...
protected:
    ...
    BmnCSCModule **Modules; //modules in the station [array]
...
public:
    ...
    BmnCSCStation(TXMLNode *stationNode, Int_t iStation,
