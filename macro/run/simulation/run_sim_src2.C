...
void run_sim_src2(TString inFile = "", TString outFile = "$VMCWORKDIR/macro/run/Sim_For_MDF_FullGeom_With_Target_Field_Scaled_1ev.root", Int_t nStartEvent = 0, Int_t nEvents = 1, Bool_t useRealEffects = kFALSE) {
    TStopwatch timer;
    timer.Start();
    gDebug = 0;
   ...
   // primGen->SetBeam(0.5, -4.6, 0.0, 0.0);
	...
	double A = 12.;
	double Z = 6.;
	double P = 3.75;//3.662;//without target 3.693; //before target  //3.75;//3.997433; //per nucleon after MWPC2
