...
void run_reco_Si_simple(TString inputFileName ="$VMCWORKDIR/macro/run/Sim_Si.root",
                  TString srcdstFileName = "$VMCWORKDIR/macro/run/recoSiSim.root",
                  Int_t nStartEvent = 0, Int_t nEvents = 1000)
{
    ...
    Int_t run_period = 7, run_number = 5096;
