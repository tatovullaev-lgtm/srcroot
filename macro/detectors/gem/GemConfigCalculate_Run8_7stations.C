...
const Double_t XStationPositions[NStations] = { +1.476/*0*/, +2.614/*1*/, +3.342/*2*/, +4.674/*3*/, +6.303/*4*/, +8.140/*5*/, +9.871/*6*/}; //center of hole for a half-plane nearest to the target
const Double_t YStationPositions[NStations] = { -0.148/*0*/, -0.107/*1*/, -0.064/*2*/, -0.120/*3*/, -0.071/*4*/, +0.123/*5*/, -0.050/*6*/}; //center of hole for a half-plane nearest to the target
const Double_t ZStationPositions[NStations] = { +61.229/*0*/, +92.2505/*1*/, +123.502/*2*/, +154.679/*3*/, +185.9235/*4*/, +217.194/*5*/, +248.344/*6*/}; //half-plane nearest to the target

const Double_t xShift[NStations] = {-0.004/*0*/, 0.0/*1*/, +0.102/*2*/, +0.05/*3*/, +0.067/*4*/, +0.098/*5*/, +0.045/*6*/};
const Double_t yShift[NStations] = {+0.125/*0*/, 0.0/*1*/, +0.131/*2*/, +0.046/*3*/, +0.136/*4*/, -0.197/*5*/, +0.122/*6*/};
const Double_t zShift[NStations] = {+3.998/*0*/, +4.101/*1*/, +4.0785/*2*/, +4.055/*3*/, +4.0985/*4*/, +3.903/*5*/, +4.1075/*6*/};
...
void GemConfigCalculate_Run8_7stations() {
