...
#define XYCALIBRATION false
#define MINSTAT 50
#define WRITE_NEW_CALIBRATION_FILES 0
#define WRITE_CALIBRATION_X false
#define WRITE_CALIBRATION_Y false
#define WRITE_CALIBRATION_X_CHAMBER false
#define WRITE_CALIBRATION_Y_CHAMBER false
...
void BmnXTIdentificationTOF700(const char *TracksGemDch = TRACKFILE, const char *DigitsTOF700 = "argon_tof700_digits_files_pro_full.txt") {
...
//    if (XYPETNEW) if (!ReadXYCalibration()) return;
    readMCTimeFile();
	...
	strcat(fname_root, "_identification_results.root");
...
//    DigiRunHeader * rh = (DigiRunHeader *) (bmnTreetof700->GetFile())->Get("DigiRunHeader");
