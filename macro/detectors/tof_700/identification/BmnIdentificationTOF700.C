...
//void BmnIdentificationTOF700(const char *TracksGemDch = "argon_tracks_merts_files.txt", const char *DigitsTOF700 = "argon_tof700_digits_files.txt") {

void BmnIdentificationTOF700(const char *TracksGemDch = "argon_tracks_gleb_newall_files.txt", const char *DigitsTOF700 = "argon_tof700_digits_files.txt") {
