/*
 * Description:
 * Macro for calculating parameters of FSD (Forward Silicon detector) and writing them
 ...
 *
 * Configuration of FSD for the future configuration of 5 stations (2026)
 *
 * Author: D. Baranov
 * Created: 04.02.2026
 */
...
const Double_t XModuleShifts[NStations][NMaxModules] = {
    ...
    {-x_dist_cent_base[4] + x_shift_hp[4] + 72.85 /*0*/,
     -x_dist_cent_base[4] + x_shift_hp[4] + 66.85 /*1*/,
     -x_dist_cent_base[4] + x_shift_hp[4] + 60.85 /*2*/,
     -x_dist_cent_base[4] + x_shift_hp[4] + 54.85 /*3*/,
     -x_dist_cent_base[4] + x_shift_hp[4] + 48.85 /*4*/,
     -x_dist_cent_base[4] + x_shift_hp[4] + 42.85 /*5*/,
     -x_dist_cent_base[4] + x_shift_hp[4] + 30.55 /*6*/,
     -x_dist_cent_base[4] + x_shift_hp[4] + 24.55 /*7*/,
     -x_dist_cent_base[4] + x_shift_hp[4] + 18.55 /*8*/,
     -x_dist_cent_base[4] + x_shift_hp[4] + 12.55 /*9*/,
     -x_dist_cent_base[4] + x_shift_hp[4] + 6.55 /*10*/,

     -x_dist_cent_base[4] + 72.85 /*11*/,
     -x_dist_cent_base[4] + 66.85 /*12*/,
     -x_dist_cent_base[4] + 60.85 /*13*/,
     -x_dist_cent_base[4] + 54.85 /*14*/,
     -x_dist_cent_base[4] + 48.85 /*15*/,
     -x_dist_cent_base[4] + 42.85 /*16*/,
     -x_dist_cent_base[4] + 30.55 /*17*/,
     -x_dist_cent_base[4] + 24.55 /*18*/,
     -x_dist_cent_base[4] + 18.55 /*19*/,
     -x_dist_cent_base[4] + 12.55 /*20*/,
     -x_dist_cent_base[4] + 6.55 /*21*/}   // st. 4
};
...
const Double_t YModuleShifts[NStations][NMaxModules] = {
    ...
    {+y_dist_cent_base[4] + y_shift_hp[4] - 22.436 /*0*/,
     +y_dist_cent_base[4] + y_shift_hp[4] - 22.436 /*1*/,
     +y_dist_cent_base[4] + y_shift_hp[4] - 22.436 /*2*/,
     +y_dist_cent_base[4] + y_shift_hp[4] - 22.436 /*3*/,
     +y_dist_cent_base[4] + y_shift_hp[4] - 22.436 /*4*/,
     +y_dist_cent_base[4] + y_shift_hp[4] - 19.436 /*5*/,
     +y_dist_cent_base[4] + y_shift_hp[4] - 22.436 /*6*/,
     +y_dist_cent_base[4] + y_shift_hp[4] - 22.436 /*7*/,
     +y_dist_cent_base[4] + y_shift_hp[4] - 22.436 /*8*/,
     +y_dist_cent_base[4] + y_shift_hp[4] - 22.436 /*9*/,
     +y_dist_cent_base[4] + y_shift_hp[4] - 22.436 /*10*/,

     -y_dist_cent_base[4] + 22.436 /*11*/,
     -y_dist_cent_base[4] + 22.436 /*12*/,
     -y_dist_cent_base[4] + 22.436 /*13*/,
     -y_dist_cent_base[4] + 22.436 /*14*/,
     -y_dist_cent_base[4] + 22.436 /*15*/,
     -y_dist_cent_base[4] + 19.436 /*16*/,
     -y_dist_cent_base[4] + 22.436 /*17*/,
     -y_dist_cent_base[4] + 22.436 /*18*/,
     -y_dist_cent_base[4] + 22.436 /*19*/,
     -y_dist_cent_base[4] + 22.436 /*20*/,
     -y_dist_cent_base[4] + 22.436 /*21*/}   // st. 4
};
...
const Double_t ZModuleShifts[NStations][NMaxModules] = {
    ...
    {+z_shift_hp[4] + z_shift_up - 2.82 /*0*/,  +z_shift_hp[4] + z_shift_up - 1.6 /*1*/,
     +z_shift_hp[4] + z_shift_up - 2.82 /*2*/,  +z_shift_hp[4] + z_shift_up - 1.6 /*3*/,
     +z_shift_hp[4] + z_shift_up - 2.82 /*4*/,  +z_shift_hp[4] + z_shift_up - 1.6 /*5*/,
     +z_shift_hp[4] + z_shift_up - 2.95 /*6*/,  +z_shift_hp[4] + z_shift_up - 1.73 /*7*/,
     +z_shift_hp[4] + z_shift_up - 2.95 /*8*/,  +z_shift_hp[4] + z_shift_up - 1.73 /*9*/,
     +z_shift_hp[4] + z_shift_up - 2.95 /*10*/,

     +z_shift_low - z_mod_thick + 2.82 /*11*/,  +z_shift_low - z_mod_thick + 1.6 /*12*/,
     +z_shift_low - z_mod_thick + 2.82 /*13*/,  +z_shift_low - z_mod_thick + 1.6 /*14*/,
     +z_shift_low - z_mod_thick + 2.82 /*15*/,  +z_shift_low - z_mod_thick + 1.6 /*16*/,
     +z_shift_low - z_mod_thick + 2.95 /*17*/,  +z_shift_low - z_mod_thick + 1.73 /*18*/,
     +z_shift_low - z_mod_thick + 2.95 /*19*/,  +z_shift_low - z_mod_thick + 1.73 /*20*/,
     +z_shift_low - z_mod_thick + 2.95 /*21*/}   // st. 4
};
...
const Bool_t ModulesYRotations[NStations][NMaxModules] = {
    ...
    {true /*0*/, true /*1*/, true /*2*/, true /*3*/, true /*4*/, false /*5*/, false /*6*/, false /*7*/, false /*8*/,
     ...
     false /*17*/},
    {true /*0*/,  true /*1*/,   true /*2*/,   true /*3*/,   true /*4*/,   true /*5*/,  false /*6*/, false /*7*/,
     false /*8*/, false /*9*/,  false /*10*/, true /*11*/,  true /*12*/,  true /*13*/, true /*14*/, true /*15*/,
     true /*16*/, false /*17*/, false /*18*/, false /*19*/, false /*20*/, false /*21*/}};
...
const Bool_t ModulesXRotations[NStations][NMaxModules] = {
    ...
    {false /*0*/, false /*1*/, false /*2*/,  false /*3*/, false /*4*/, false /*5*/, false /*6*/, false /*7*/,
     false /*8*/, false /*9*/, false /*10*/, true /*11*/, true /*12*/, true /*13*/, true /*14*/, true /*15*/,
     true /*16*/, true /*17*/, true /*18*/,  true /*19*/, true /*20*/, true /*21*/}};
...
void SiliconConfigCalculate_5stations_2026()
{

    TString ConfigName = "Silicon_5stations_2026";
    TString AuthorName = "Baranov D.";
    TString DateCreated = "04.02.2026";
...
void PrintInfo()
{
    ...
    cout << "    pitch = " << PitchValue[STANDARD_MODULE][0] << "\n";
    cout << "    angle = " << StripAngle[STANDARD_MODULE][0] << " deg\n";
    cout << "    first_strip_number = " << FirstStripNumberLowLayer[STANDARD_MODULE][0] << "\n";
    ...
    cout << "    pitch = " << PitchValue[STANDARD_MODULE][1] << "\n";
    cout << "    angle = " << StripAngle[STANDARD_MODULE][1] << " deg\n";
    cout << "    first_strip_number = " << FirstStripNumberLowLayer[STANDARD_MODULE][1] << "\n";
    cout << "    dead_zone(3 points):\n";
    ...
    cout << "    pitch = " << PitchValue[LONG_MODULE][0] << "\n";
    cout << "    angle = " << StripAngle[LONG_MODULE][0] << " deg\n";
    cout << "    first_strip_number = " << FirstStripNumberLowLayer[LONG_MODULE][0] << "\n";
    cout << "    dead_zone(3 points):\n";
    ...
    cout << "    pitch = " << PitchValue[LONG_MODULE][1] << "\n";
    cout << "    angle = " << StripAngle[LONG_MODULE][1] << " deg\n";
    cout << "    first_strip_number = " << FirstStripNumberLowLayer[LONG_MODULE][1] << "\n";
    cout << "    dead_zone(3 points):\n";
...
void CalculateParameters(TString config_name, TString author, TString date)
{
    ...
    ofstream SiFileOut(FileName.Data(), ios::out);

    SiFileOut << "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n";
    ...
    SiFileOut << "<!--\
        ...
        \r\tIf you look at the FSD from the target:\
    ...
    for (Int_t istation = 0; istation < NStations; ++istation) {
        ...
        for (Int_t imodule = 0; imodule < NModulesInStations[istation]; ++imodule) {
            ...
            /*
                        ...
                        SiFileOut << " rotOrder=\"" << "XYZ" << "\"";
                        SiFileOut << " xRotationDeg=\"" << 0.0 << "\"";
                        if(imodule < NModulesInStations[istation]/2)  SiFileOut << " yRotationDeg=\"" <<
               HalfPlanesYRotations[istation][0] << "\""; //modules of upper half-plane else SiFileOut << "
               yRotationDeg=\"" << HalfPlanesYRotations[istation][1] << "\""; //modules of lower half-plane SiFileOut <<
               " zRotationDeg=\"" << 0.0 << "\""; SiFileOut << " xTranslation=\"" << 0.0 << "\""; SiFileOut << "
               yTranslation=\"" << 0.0 << "\""; SiFileOut << " zTranslation=\"" << 0.0 << "\""; SiFileOut << " />\n";
