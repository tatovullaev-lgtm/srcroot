...
void create_rootgeom_SiBT_Run9_detailed()
{
...
TGeoVolume* CreateVacuumTube(TString vacTube_name)
{
    ...
    // shapes
    TGeoShape* vacTubeS =
        new TGeoTube(TString("vacTubeS") += TString("_") + vacTube_name, 21.3 * 0.5, 21.9 * 0.5, 19.6 * 0.5);
    TGeoShape* vacTubeHoleS =
        new TGeoTube(TString("vacTubeHoleS") += TString("_") + vacTube_name, 0.0, 15.905 * 0.5, 10. * 0.5);

    TGeoShape* sideTubeS =
        new TGeoTube(TString("sideTubeS") += TString("_") + vacTube_name, 15.3 * 0.5, 15.9 * 0.5, 15.0 * 0.5);
    TGeoShape* sideTubeCutS =
        new TGeoTube(TString("sideTubeCutS") += TString("_") + vacTube_name, 0.0, 21.3 * 0.5, 19.6 * 0.5);

    TGeoShape* vacTubeFlangeS =
        new TGeoTube(TString("vacTubeFlangeS") += TString("_") + vacTube_name, 21.9 * 0.5, 24.0 * 0.5, 1.2 * 0.5);
    TGeoShape* sideTubeFlangeS =
        new TGeoTube(TString("sideTubeFlangeS") += TString("_") + vacTube_name, 15.9 * 0.5, 18.0 * 0.5, 1.2 * 0.5);
    ...
    if (vacTube_name.Contains("station0") || vacTube_name.Contains("station1"))
        vacTubeWithHoleV_medium = pMedSteel;
    if (vacTube_name.Contains("station2"))
