/*
 * Use this macro to create ROOT geometry for the RunSRCSpring2018 SILICON
...
const ModuleType ModulesTypes[NStations][NMaxModules] = {
    ...
    {RIGHT_ANGLED_MODULE, RIGHT_ANGLED_MODULE, RIGHT_ANGLED_MODULE, RIGHT_ANGLED_MODULE, RIGHT_ANGLED_MODULE, BEVEL_MODULE, BEVEL_MODULE, RIGHT_ANGLED_MODULE}
};
...
void create_rootgeom_Silicon_RunSRCSpring2018() {
