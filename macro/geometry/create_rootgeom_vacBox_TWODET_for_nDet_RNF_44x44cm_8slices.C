...
void create_rootgeom_vacBox_TWODET_for_nDet_RNF_44x44cm_8slices(Double_t nDet_dist_1=700, Double_t rotY_1=-10, Double_t rotX_1=-4.5, Double_t nDet_dist_2=700, Double_t rotY_2=-10, Double_t rotX_2=4.5) {
    ...
    const TString geoDetectorName = "vacBox_TWODET_for_nDet_RNF_44x44cm_8slices";
...
//DET 2
  ...
  TString geoFileName = gPath + "/geometry/" + geoDetectorName + "_" + "ZdistDET_1_" + sDist_1_1 + "." + sDist_2_1 + "cm_" + "rotY_"  + sRotY_1_1  +  "." + sRotY_2_1 + "deg" + "_" + "rotX_"  + sRotX_1_1 + "." + sRotX_2_1 + "deg" + "_ZdistDET_2_" + sDist_1_2 + "." + sDist_2_2 + "cm_" + "rotY_"  + sRotY_1_2  +  "." + sRotY_2_2 + "deg" + "_" + "rotX_"  + sRotX_1_2 + "." + sRotX_2_2 + "deg"".root";
...
//DET 1  
  ...
  local[0] = 0; local[1] = 0; local[2] = vacBox_dist_1;//699.9 
...
//DET 2  
  master[0] = 0; master[1] = 0; master[2] = 0; 
  local[0] = 0; local[1] = 0; local[2] = vacBox_dist_2;//699.9 
  ...
  TGeoCombiTrans *wallWALL_before_2 = new TGeoCombiTrans("wallWALL_before_2",WALL_center_Xpos, WALL_center_Ypos, WALL_center_Zpos,rot_2);
    //cout <<"WALL before " <<WALL_center_Xpos <<" " <<WALL_center_Ypos <<" " <<WALL_center_Zpos <<endl;
...
//DET 1
  master[0] = 0; master[1] = 0; master[2] = 0; 
  local[0] = 0; local[1] = 0; local[2] = nDet_dist_1+2.*nDet_Z_size+Wall_nDet_dist; 
  rot->LocalToMaster(local, master);
...
//DET 2
  master[0] = 0; master[1] = 0; master[2] = 0; 
  local[0] = 0; local[1] = 0; local[2] = nDet_dist_2+2.*nDet_Z_size+Wall_nDet_dist; 
  rot_2->LocalToMaster(local, master);
  ...
  WALL_center_Zpos = master[2];
    ...
    TGeoCombiTrans *wallWALL_after_2 = new TGeoCombiTrans("wallWALL_after_2",WALL_center_Xpos, WALL_center_Ypos, WALL_center_Zpos,rot_2);
...
//DET 1
  master[0] = 0; master[1] = 0; master[2] = 0; 
  local[0] = 0; local[1] = Wall_Y_size+Wall_nDet_dist; local[2] = nDet_dist_1+nDet_Z_size; 
  rot->LocalToMaster(local, master);
...
//DET 2
  master[0] = 0; master[1] = 0; master[2] = 0; 
  local[0] = 0; local[1] = Wall_Y_size+Wall_nDet_dist; local[2] = nDet_dist_2+nDet_Z_size; 
  rot_2->LocalToMaster(local, master);
  ...
  WALL_center_Zpos = master[2];
    ...
    TGeoCombiTrans *wallWALL_above_2 = new TGeoCombiTrans("wallWALL_above_2",WALL_center_Xpos, WALL_center_Ypos, WALL_center_Zpos,rot_2);
    //cout <<"WALL_above_Ypos " <<WALL_Zpos_ABOVE <<endl;
...
//DET 2
  ...
  WALL_center_Zpos = master[2];
    ...
    TGeoCombiTrans *wallWALL_under_2 = new TGeoCombiTrans("wallWALL_under_2",WALL_center_Xpos, WALL_center_Ypos, WALL_center_Zpos,rot_2);
    //cout <<"WALL_above_Ypos " <<WALL_Zpos_ <<endl;
...
//DET 1
  master[0] = 0; master[1] = 0; master[2] = 0; 
  local[0] = Wall_X_size+Wall_nDet_dist; local[1] = 0; local[2] = nDet_dist_1+nDet_Z_size; 
  rot->LocalToMaster(local, master);
...
//DET 2
  master[0] = 0; master[1] = 0; master[2] = 0; 
  local[0] = Wall_X_size+Wall_nDet_dist; local[1] = 0; local[2] = nDet_dist_2+nDet_Z_size; 
  rot_2->LocalToMaster(local, master);
  ...
  WALL_center_Zpos = master[2];
    ...
    TGeoCombiTrans *wallWALL_left_2 = new TGeoCombiTrans("wallWALL_left_2",WALL_center_Xpos, WALL_center_Ypos, WALL_center_Zpos,rot_2);
    //cout <<"WALL_left_Xpos " <<WALL_Zpos_LEFT <<endl;
...
//DET 2
  ...
  WALL_center_Zpos = master[2];
    ...
    TGeoCombiTrans *wallWALL_right_2 = new TGeoCombiTrans("wallWALL_right_2",WALL_center_Xpos, WALL_center_Ypos, WALL_center_Zpos,rot_2);
    //cout <<"WALL_right_Xpos " <<WALL_Zpos_RIGHT <<endl;
