...
const Double_t DCH2_Xpos = +25.0 + 7.8; // 25cm - shifting; 7.8cm - alignment.
const Double_t DCH2_Ypos = +5.8; //5.8cm - alignment
const Double_t DCH2_Zpos = 720.0;//748.35; //cm
...
void create_rootgeom_DCH2_run3() {
