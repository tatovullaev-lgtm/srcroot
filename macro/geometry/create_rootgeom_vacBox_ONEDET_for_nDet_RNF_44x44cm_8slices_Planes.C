...
Double_t nDet_Z_size = 24.8;   // 49.6/2.//Veto+15Cu
...
// void create_rootgeom_vacBox_ONEDET_for_nDet_RNF_44x44cm_16slices(Double_t vacBox_dist=0,Double_t WALL_Xpos=0,Double_t
// WALL_Ypos=0,Double_t WALL_Zpos=900,Double_t WALL_Xpos_after=0,Double_t WALL_Ypos_after=0,Double_t
// WALL_Zpos_after=900,Double_t WALL_Xpos_ABOVE=0,Double_t WALL_Ypos_ABOVE=0,Double_t WALL_Zpos_ABOVE=900,Double_t
// WALL_Xpos_LEFT=0,Double_t WALL_Ypos_LEFT=0,Double_t WALL_Zpos_LEFT=900,Double_t WALL_Xpos_RIGHT=0,Double_t
// WALL_Ypos_RIGHT=0,Double_t WALL_Zpos_RIGHT=900,Double_t rotY=0) {
void create_rootgeom_vacBox_ONEDET_for_nDet_RNF_44x44cm_8slices_Planes(Double_t nDet_dist = 780,
                                                                       Double_t rotY = 0,
                                                                       Double_t rotX = 0)
{
    ...
    const TString geoDetectorName = "vacBox_ONEDET_for_nDet_RNF_44x44cm_8slices_Planes";
    ...
    TString geoFileName = gPath + "/geometry/" + geoDetectorName + "_" + "Zdist_" + sDist_1 + "." + sDist_2 + "cm_"
                          + "rotY_" + sRotY_1 + "." + sRotY_2 + "deg" + "_" + "rotX_" + sRotX_1 + "." + sRotX_2 + "deg"
                          + ".root";
...
//Det 1
  ...
  TString geoFileName = gPath + "/geometry/" + geoDetectorName + "_" + "Zdist_" + sDist_1 +  "." + sDist_2 +"cm" + "_" +
"rotY_"  + sRotY_1 +  "." + sRotY_2 + "deg" + ".root";
    */
...
//Wall after
    ...
    rot->RotateY(rotY);
    TGeoCombiTrans *wallWALL_after = new TGeoCombiTrans("wallWALL_after",WALL_Xpos_after, WALL_Ypos_after,
WALL_center_Zpos_after,rot);
    ...
    */
    ...
    local[0] = 0;
    local[1] = 0;
    local[2] = nDet_dist + 2. * nDet_Z_size + Wall_nDet_dist;
    rot->LocalToMaster(local, master);
