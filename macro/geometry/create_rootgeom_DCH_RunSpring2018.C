...
const Double_t OuterRadiusOfOctagon =
    (2.414 * SideLengthOfOctagon) / 2.0;   // incircle radius, where 2.414 is a constant
...
void create_rootgeom_DCH_RunSpring2018()
{
    ...
    if (!mMylar)
        Fatal("Main", "FairMedium mMylar not found");
    ...
    TGeoCombiTrans* combi1 =
        new TGeoCombiTrans(DCH1_Xpos, DCH1_Ypos, DCH1_Zpos, new TGeoRotation("rot", 45 * 0.5, 0, 0));
    TGeoCombiTrans* combi2 =
        new TGeoCombiTrans(DCH2_Xpos, DCH2_Ypos, DCH2_Zpos, new TGeoRotation("rot", 45 * 0.5, 0, 0));
    ...
    OctagonActivePlaneS->DefineSection(
        0, -ActiveVolumeThickness * 0.5, InnerRadiusOfOctagon, OuterRadiusOfOctagon_ActivePlane);
    OctagonActivePlaneS->DefineSection(
        1, +ActiveVolumeThickness * 0.5, InnerRadiusOfOctagon, OuterRadiusOfOctagon_ActivePlane);
