...
const Double_t XStationPositions[NStations] = {+0.4025 /*0*/, +0.726 /*1*/, 0.8415 /*2*/,
                                               +0.877 /*3*/};   // центр отверстия нижней п.плоскости
const Double_t YStationPositions[NStations] = {-0.159 /*0*/, -0.165 /*1*/, -0.122 /*2*/,
                                               -0.111 /*3*/};   // центр отверстия нижней п.плоскости
const Double_t ZStationPositions[NStations] = {
    +14.2735 /*0*/, +23.022 /*1*/, 31.594 /*2*/,
    40.407 /*3*/};   // реперная точка (средняя измеренная позиция по нижним п.плоскостям (ближним к мишени))
...
const Double_t z_shift_hp[NStations] = {
    +5.0 /*0*/, 5.134 /*1*/, 5.2825 /*2*/,
    5.106 /*3*/};   // см, z-сдвиг верхней полуплоскости относительно нижней для разных станций

const Double_t x_shift_hp[NStations] = {
    +0.1255 /*0*/, -0.0105 /*1*/, +0.013 /*2*/,
    +0.239 /*3*/};   // см, x-сдвиг центра отверстия верхней полуплоскости относительно нижней

const Double_t y_shift_hp[NStations] = {
    +0.1495 /*0*/, +0.0425 /*1*/, +0.0265 /*2*/,
    +0.5025 /*3*/};   // см, y-сдвиг центра отверстия верхней полуплоскости относительно нижней
...
void create_rootgeom_Silicon_Run8_detailed()
{
    ...
    for (Int_t istation = 0; istation < NStations; ++istation) {
        ...
        // frame shift for 0-station to avoid overlapping with vac.pipe (RUN-8)!
        if (istation == 0)
            frames_transform->SetDx(+0.06);
