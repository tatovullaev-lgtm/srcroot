...
void create_rootgeom_MWPC_RunSpring2018() {
    ...
    const Double_t MWPC0_Xpos = 0.234;
    const Double_t MWPC0_Ypos = 6.14;
    const Double_t MWPC0_Zpos = -207.624-ZLengthChamber/2.0;
    
    const Double_t MWPC1_Xpos = 0.271;
    const Double_t MWPC1_Ypos = 6.038;
    const Double_t MWPC1_Zpos = -357.333-ZLengthChamber/2.0;          
