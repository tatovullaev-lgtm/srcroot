...
Double_t ScWall_Z_size =1.25; //half of 25 mm (2.5 cm)
...
Double_t ScWall_full_cell_Z_size_small = 1.25; //half of 25 mm
...
Double_t ScWall_full_cell_Z_size_large = 1.25; //half of 25 mm
...
void create_rootgeom_ScWall_Cell_25mm_Simple_oldnames_with_hole_cells_numbering_for_run8_v1(Double_t ScWall_Xpos=65.65,Double_t ScWall_Ypos=-0.43,Double_t ScWall_Zpos=697.4,Double_t rotY=0) {//with Y shift
...
// -------   Geometry file name (output)   ---------------------------------
  const TString geoDetectorName = "ScWall_Cell_25mm_Simple_with_hole_cells_numbering_for_run8";
