...
void create_rootgeom_nDet_PROTOTYPE_ONEDET_12x12cm_9mods_4x4cm_with_rows_columns_NEW_NUMBERING_VETO_25mm_5slices_PLA_2mm_Pb_8mm_9slices_Cu_30mm_Sc_25mm_G10_2mm_Air_no_hole_v1(
    ...
    Double_t rotX_1 = 0)
{
    ...
    const TString geoDetectorName = "nDet_PROTOTYPE_ONEDET_12x12cm_9mods_4x4cm_with_rows_columns_NEW_NUMBERING_VETO_"
                                    "25mm_5slices_PLA_2mm_Pb_8mm_9slices_Cu_30mm_Sc_25mm_G10_2mm_Air_no_hole";
    ...
    for (Int_t iy = 0; iy < Zdc_NRows_NICA; iy++) {   // 19
        ...
        for (Int_t ix = 0; ix < Zdc_NColumns_NICA; ix++) {   // 19
            ...
            zdcModuleS_NICA[iMod] = new TGeoBBox(BmnNdetGeoPar::fModuleVolumeName,
                                                 Zdc_module_X_size_NICA,
                                                 Zdc_module_Y_size_NICA,
                                                 Zdc_module_Z_size_NICA);
    ...
    */
    ...
    NDET_common->AddNode(ZDCV, 0, zdcZDC_1);   // NDET
    // return;
