...
void create_rootgeom_nDet_noFrame_Planes_RNF_ONEDET_44x44cm_121mods_4x4cm_with_rows_columns_NEW_NUMBERING_VETO_25mm_7slices_Cu_30mm_Sc_25mm_PCB_1mm_PLA_2mm_Al_1_5mm_Air_3mm(
    Double_t nDet_dist_1 = 780,
    Double_t rotY_1 = 0,
    Double_t rotX_1 = 0)
{
    ...
    const TString geoDetectorName = "nDet_noFrame_Planes_RNF_ONEDET_44x44cm_121mods_4x4cm_with_rows_columns_NEW_"
  ...
  //DET_2
    ...
    TGeoCombiTrans *zdcZDC_2 = new TGeoCombiTrans("zdcZDC_2",ZDC_center_Xpos_2, ZDC_center_Ypos_2,
  ZDC_center_Zpos_2,rot2); NDET_common->AddNode(ZDCV, 2, zdcZDC_2);//NDET
    //return;
    */
