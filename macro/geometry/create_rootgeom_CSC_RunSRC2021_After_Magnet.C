...
const Double_t XStationPositions[NStations] = { 43.707+0.5/*0*/, -110.0/*1*/, 130.0/*2*/, -130.0/*3*/}; //geometry center
const Double_t YStationPositions[NStations] = { 0.511-4.7/*0*/, 0.0/*1*/, 0.0/*2*/, 0.0/*3*/}; //geometry center
const Double_t ZStationPositions[NStations] = { 1001.132-576.2/*0*/, 410.0/*1*/, 470.0/*2*/, 470.0/*3*/}; //outer side nearest to the target
...
void create_rootgeom_CSC_RunSRC2021_After_Magnet() {

    // ----  set working directory  --------------------------------------------
    TString gPath = gSystem->Getenv("VMCWORKDIR");

    // -------   Geometry file name (output)   ----------------------------------
    const TString geoDetectorName = "CSC_After_Magnet";
    const TString geoDetectorVersion = "Run8_SRC_detailed";
