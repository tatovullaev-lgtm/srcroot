...
void create_rootgeom_nDet_PROTOTYPE_ONEDET_12x12cm_9mods_4x4cm_with_rows_columns_VETO_25mm_5slices_PLA_2mm_Pb_8mm_9slices_Cu_30mm_Sc_25mm_G10_2mm_Air_no_hole_v1(Double_t nDet_dist_1=595.617,Double_t rotY_1=-27.3, Double_t rotX_1=0) {
...
// -------   Geometry file name (output)   --------------------------------
  const TString geoDetectorName = "nDet_PROTOTYPE_ONEDET_12x12cm_9mods_4x4cm_with_rows_columns_VETO_25mm_5slices_PLA_2mm_Pb_8mm_9slices_Cu_30mm_Sc_25mm_G10_2mm_Air_no_hole";
  ...
  TString geoFileName = gPath + "/geometry/" + geoDetectorName + "_" + "ZdistDET_1_" + sDist_1_1 + "." + sDist_2_1 + "cm_" + "rotY_"  + sRotY_1_1  +  "." + sRotY_2_1 + "deg" + "_" + "rotX_"  + sRotX_1_1 + "." + sRotX_2_1 + "deg" + ".root";
...
//Fill ZDC with NICA modules
  ...
  for(Int_t iy=0; iy<Zdc_NRows_NICA; iy++) {//19
    ...
    for(Int_t ix=0; ix<Zdc_NColumns_NICA; ix++) {//19
      ...
      zdcModuleV_NICA[iMod]->SetName(Form("%s_%d_%d", (BmnNdetGeoPar::fModuleVolumeName).Data(), rowNb, ix+1)) ;
      modNb=iMod+1;  
      cout <<"zdcModuleV_NICA " <<zdcModuleV_NICA[iMod]->GetName() <<" " <<rowNb <<" " <<ix+1 <<" " <<modNb <<endl; 
