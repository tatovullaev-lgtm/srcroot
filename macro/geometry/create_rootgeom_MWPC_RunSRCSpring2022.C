...
void create_rootgeom_MWPC_RunSRCSpring2022() {
    ...
    //Detector's position
    const Double_t MWPC0_Xpos = 0.5+0.248;
    const Double_t MWPC0_Ypos =-4.6-0.0148;
    const Double_t MWPC0_Zpos = -249.222 + 5 + Zshift;
    
    const Double_t MWPC1_Xpos = 0.5-0.113;
    const Double_t MWPC1_Ypos = -4.6-0.073;
    const Double_t MWPC1_Zpos = -175.424 + 5 + Zshift;  
    
    const Double_t MWPC2_Xpos = 0.5+0.078;
    const Double_t MWPC2_Ypos = -4.6-0.564;
    const Double_t MWPC2_Zpos = 220.431 - 5  + Zshift;
    
    const Double_t MWPC3_Xpos = 0.5-0.038;
    const Double_t MWPC3_Ypos = -4.6-0.331;
    const Double_t MWPC3_Zpos = 346.541 - 5 + Zshift;        
