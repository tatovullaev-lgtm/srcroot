 ...
 * Strip Chamber) detector for the RUN-8 full configuration (4 small chamber +
 * 1 large chamber)
 *
 * Author: Baranov D.
 * Created: 01.12.2022
...
const Double_t XStationPositions[NStations] = {+164.581 /*0*/, -112.187 /*1*/, +156.925 /*2*/, -98.240 /*3*/,
                                               +51.841 /*4*/};   // geometry center
const Double_t YStationPositions[NStations] = {+0.003 /*0*/, +0.051 /*1*/, +0.029 /*2*/, +0.096 /*3*/,
                                               +0.133 /*4*/};   // geometry center
const Double_t ZStationPositions[NStations] = {+400.467 /*0*/, +399.021 /*1*/, 462.005 /*2*/, +460.898 /*3*/,
                                               +816.0085 /*4*/};   // outer side nearest to the target

//(X-Y-Z)Shifts of modules in each station
const Double_t XModuleShifts[NStations][NMaxModules] = {
    // centers of gas volume
    {0.0, 0.0},   // station 0
    {0.0, 0.0},   // station 1
    {0.0, 0.0},   // station 2
    {0.0, 0.0},   // station 3
...
const Double_t YModuleShifts[NStations][NMaxModules] = {
    ...
    {+36.5 /*0*/, +36.5 /*1*/, +36.5 /*2*/, +36.5 /*3*/, -36.5 /*4*/, -36.5 /*5*/, -36.5 /*6*/,
     -36.5 /*7*/}   // station 4
};
const Double_t ZModuleShifts[NStations][NMaxModules] = {
    ...
    {1.25, 1.25},                                                                              // station 2
    {1.25, 1.25},                                                                              // station 3
    {2.5 /*0*/, 2.5 /*1*/, 2.5 /*2*/, 2.5 /*3*/, 2.5 /*4*/, 2.5 /*5*/, 2.5 /*6*/, 2.5 /*7*/}   // station 4
};
...
const ModuleType ModuleTypes[NStations][NMaxModules] = {
    {WHOLE_MOD, WHOLE_MOD},   // station 0
    {WHOLE_MOD, WHOLE_MOD},   // station 1
    {WHOLE_MOD, WHOLE_MOD},   // station 2
    {WHOLE_MOD, WHOLE_MOD},   // station 3
    {WHOLE_MOD /*0*/, HOLED_LEFT_MOD /*1*/, HOLED_RIGHT_MOD /*2*/, WHOLE_MOD /*3*/, WHOLE_MOD /*4*/,
     HOLED_RIGHT_MOD /*5*/, HOLED_LEFT_MOD /*6*/, WHOLE_MOD /*7*/}   // station 4
};

const Bool_t ModulesYRotations[NStations][NMaxModules] = {
    {false, false},                                                                                        // station 0
    {false, false},                                                                                        // station 1
    {false, false},                                                                                        // station 2
    {false, false},                                                                                        // station 3
    {false /*0*/, false /*1*/, false /*2*/, false /*3*/, true /*4*/, true /*5*/, true /*6*/, true /*7*/}   // station 4
};
...
void create_rootgeom_FullCSC_Run8_detailed()
{
    ...
    const TString geoDetectorName = "FullCSC";
    ...
    for (Int_t istation = 0; istation < NStations; ++istation) {
        // for(Int_t istation = 4; istation < 5; ++istation) {
