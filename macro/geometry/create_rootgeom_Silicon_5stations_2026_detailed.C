 ...
 * for the next runs (5 Si-Stations (6-10-14-18-22 modules))
 *
 * Author: Baranov D.
 * Date: 22.12.2025 (created)
 *
...
void create_rootgeom_Silicon_5stations_2026_detailed()
{
    ...
    const TString geoDetectorVersion = "5stations_2026_detailed";
