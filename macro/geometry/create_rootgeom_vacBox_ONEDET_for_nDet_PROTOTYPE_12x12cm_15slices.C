...
void create_rootgeom_vacBox_ONEDET_for_nDet_PROTOTYPE_12x12cm_15slices(Double_t nDet_dist=595.617, Double_t Yshift_1=0.518, Double_t rotY=-27.3, Double_t rotX=0) {
    ...
    const TString geoDetectorName = "vacBox_ONEDET_for_nDet_PROTOTYPE_12x12cm_15slices";
    //const TString geoDetectorName = "test_vacBox_ONEDET_for_nDet_PROTOTYPE_12x12cm_15slices";
  ...
  //Int_t dist_22 = Int_t(10*(vacBox_dist-Int_t(vacBox_dist)))+1;//9
  //Int_t dist_22 = Int_t(100*(vacBox_dist-Int_t(vacBox_dist)));//9
  //Int_t dist_22 = Int_t(100*(vacBox_dist-Int_t(vacBox_dist)))+1;//9
  //Int_t dist_22 = Int_t(1000*(vacBox_dist-Int_t(vacBox_dist)));//9 //+4.5deg
  Int_t dist_22 = Int_t(1000*(vacBox_dist-Int_t(vacBox_dist)))+1;//9 //+4.5deg
  ...
  Int_t rotY_22 = -Int_t(100*(rotY-Int_t(rotY)));//9//-27.3deg
  ...
  TString geoFileName = gPath + "/geometry/" + geoDetectorName + "_" + "Zdist_" + sDist_1 + "." + sDist_2 + "cm_Ysh_" + sYsh_1_1 + "." + sYsh_2_1 + "cm_rotY_"  + sRotY_1  +  "." + sRotY_2 + "deg" + "_" + "rotX_"  + sRotX_1 + "." + sRotX_2 + "deg" + ".root";
...
//Wall before
  ...
  WALL_center_Zpos = master[2];
    ...
    cout <<"Before " <<WALL_center_Xpos <<" " <<WALL_center_Ypos <<" " <<WALL_center_Zpos <<endl; 
...
//Wall after
  ...
  WALL_center_Zpos = master[2];
    ...
    cout <<"After " <<WALL_center_Xpos <<" " <<WALL_center_Ypos <<" " <<WALL_center_Zpos <<endl; 
...
//Wall above
  ...
  WALL_center_Zpos = master[2];
    ...
    cout <<"Above " <<WALL_center_Xpos <<" " <<WALL_center_Ypos <<" " <<WALL_center_Zpos <<endl; 
//===========================
//Wall under
  master[0] = 0; master[1] = 0; master[2] = 0; 
  local[0] = 0; local[1] = -(Wall_Y_size+Wall_nDet_dist); local[2] = nDet_dist+nDet_Z_size; 
  ...
  WALL_center_Zpos = master[2];
    ...
    cout <<"Under " <<WALL_center_Xpos <<" " <<WALL_center_Ypos <<" " <<WALL_center_Zpos <<endl; 
...
//Wall left
  ...
  WALL_center_Zpos = master[2];
    ...
    cout <<"Left " <<WALL_center_Xpos <<" " <<WALL_center_Ypos <<" " <<WALL_center_Zpos <<endl; 
...
//Wall right
  ...
  WALL_center_Zpos = master[2];
    ...
    cout <<"Right " <<WALL_center_Xpos <<" " <<WALL_center_Ypos <<" " <<WALL_center_Zpos <<endl; 
