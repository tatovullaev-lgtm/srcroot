...
void create_rootgeom_nDet_RNF_TWODET_44x44cm_121mods_4x4cm_with_rows_columns_NEW_NUMBERING_VETO_25mm_7slices_Cu_30mm_Sc_25mm_PCB_2mm_PLA_2mm_no_hole(Double_t nDet_dist_1=700, Double_t rotY_1=-10, Double_t rotX_1=-4.5, Double_t nDet_dist_2=700, Double_t rotY_2=-10, Double_t rotX_2=4.5) {
...
// -------   Geometry file name (output)   --------------------------------
  const TString geoDetectorName = "nDet_RNF_TWODET_44x44cm_121mods_4x4cm_with_rows_columns_NEW_NUMBERING_VETO_25mm_7slices_Cu_30mm_Sc_25mm_PCB_2mm_PLA_2mm_no_hole";
...
//Det 
  ...
  TString geoFileName = gPath + "/geometry/" + geoDetectorName + "_" + "ZdistDET_1_" + sDist_1_1 + "cm_" + "rotY_"  + sRotY_1_1  +  "." + sRotY_2_1 + "deg" + "_" + "rotX_"  + sRotX_1_1 + "." + sRotX_2_1 + "deg" + "_" + "ZdistDET_2_" + sDist_2_2 + "cm_" + "rotY_"  + sRotY_2_2  +  "." + sRotY_22_2 + "deg" + "_" + "rotX_"  + sRotX_2_2 + "." + sRotX_22_2 + "deg" + ".root";
...
//DET_2
  ...
  Double_t local_2[3];
  local_2[0] = 0; local_2[1] = 0; local_2[2] = nDet_dist_2+Zdc_Z_size; 
  ...
  TGeoCombiTrans *zdcZDC_2 = new TGeoCombiTrans("zdcZDC_2",ZDC_center_Xpos_2, ZDC_center_Ypos_2, ZDC_center_Zpos_2,rot2);
  NDET_common->AddNode(ZDCV, 2, zdcZDC_2);//NDET 
  //return;
...
//Shapes
 ...
 G10V_NICA->SetLineColor(kOrange);
 G10V_NICA->SetFillColor(kOrange);
 ...
 PLAV_NICA->SetLineColor(kViolet+3);
 PLAV_NICA->SetFillColor(kViolet+3);
