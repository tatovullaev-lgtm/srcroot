...
void create_rootgeom_Silicon_Run8_mods_10_14rot_18_detailed() {
    ...
    const TString geoDetectorVersion = "Run8_mods_10_14rot_18_detailed";
    ...
    //for(Int_t istation = 0; istation < 3; ++istation) {
        ...
        if(istation == 1) station_transform->RotateZ(+2.5);
