...
Double_t
  ...
  size_z_steel_tube = 500 ,      // mm   // ? suggested by EL

  size_xy_scint_strip = 7 ,      // mm
  size_z_scint_strip = 150,      // mm
...
// helper streams
 ...
 //__________________________ BD mother volume  _______________________________________
  ...
  mother->SetPosition(0,0,pos_z_mother_volume);
 ...
 //__________________________ one scintillator strip   _______________________________________
  ...
  coord[2] = pos_z_begin_of_active_zone_from_target_center+size_z_scint_strip/2-pos_z_mother_volume;
