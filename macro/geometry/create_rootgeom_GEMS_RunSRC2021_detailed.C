 ...
 * ROOT geometry for the SRC GEMs in the future configuration
...
const Double_t ZStationPositions[NStations] = {
    +96.003 - 576.2 /* −480.197 */, //station 0 (left-arm GEM)
    +96.003 - 576.2 /* -480.197 */  //station 1 (right-arm GEM)
};
//------------------------------------------------------------------------------
...
//const Bool_t YStationRotations[NStations] = {false/*0*/, false/*1*/};

//rotations of stations around x-axis by 180 deg.
//const Bool_t XStationRotations[NStations] = {false/*0*/, false/*1*/};
//------------------------------------------------------------------------------
...
const Double_t dZFrame_Station66x41 = 2.1;
//------------------------------------------------------------------------------
...
void create_rootgeom_GEMS_RunSRC2021_detailed() {
    ...
    //station 0 (small 66x41 GEM: left-arm)
    if(1) {
        ...
        TGeoCombiTrans *module0_transform = new TGeoCombiTrans();
            module0_transform->RotateZ(-90.0); //deg
            module0_transform->RotateY(180.0); //deg
        ...
        TGeoCombiTrans *frame0_transform = new TGeoCombiTrans();
            frame0_transform->RotateZ(-90.0); //deg
            frame0_transform->RotateY(180.0); //deg
    ...
    //station 1 (small 66x41 GEM: right-arm)
    if(1) {
