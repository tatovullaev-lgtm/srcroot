...
Double_t Wall_X_size = 135;//270/2
Double_t Wall_Y_size = 60;//120/2
...
void create_rootgeom_wall_oldnames_vacuum_zdc_270x120cm(Double_t WALL_Xpos=0,Double_t WALL_Ypos=0,Double_t WALL_Zpos=900,Double_t rotY=0) {
    ...
    const TString geoDetectorName = "wall_vacuum_zdc_270x120cm";
  ...
  */
  ...
  Int_t Yshift_2 = TMath::Abs(Int_t(100*(WALL_Ypos))); //cm
  sYshift_2 += Yshift_2;
