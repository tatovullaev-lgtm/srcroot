...
Double_t Wall_X_size = 6;//12/2
Double_t Wall_Y_size = 6;//12/2
...
void create_rootgeom_wall_oldnames_vacuum_zdc_12x12cm(Double_t WALL_Xpos=0,Double_t WALL_Ypos=0,Double_t WALL_Zpos=829.6,Double_t rotY=0) {
    ...
    const TString geoDetectorName = "wall_oldnames_vacuum_zdc_12x12cm";
  ...
  Int_t Xshift_2 = Int_t(0.5+1000*(TMath::Abs(WALL_Xpos)-Int_t(TMath::Abs(WALL_Xpos)))); //cm
  ...
  Int_t Yshift_2 = Int_t(1000*(WALL_Ypos-Int_t(WALL_Ypos))); //cm
  ...
  //Int_t Zshift_2 = Int_t(1000*(WALL_Zpos-Int_t(WALL_Zpos)))+1; //cm
  Int_t Zshift_2 = Int_t(1000*(WALL_Zpos-Int_t(WALL_Zpos))); //cm
  ...
  Int_t rotY_2 = TMath::Abs(Int_t(100*(rotY-Int_t(rotY))))+1;//9 from 2.9
  //Int_t rotY_2 = TMath::Abs(Int_t(100*(rotY-Int_t(rotY))));//9 from 2.9
  ...
  //TString geoFileName = gPath + "/geometry/" + geoDetectorName + "_" + "Zpos_" + sZshift_1 + "." + sZshift_2 + "cm" + "_" + "Xshift_" + sXshift_1 + "." + sXshift_2 + sXshift_3 + "cm" + "_" + "Yshift_" + sYshift_1 + "." + sYshift_2 + "cm" + "_" + "rotationY_"  + sRotY_1  +  "." + sRotY_2 + "deg_" + geoDetectorVersion + ".root";
    ...
    //HO_common->SetMedium(pMedVacuum);
