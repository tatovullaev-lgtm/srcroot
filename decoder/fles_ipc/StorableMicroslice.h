...
class StorableMicroslice : public Microslice
{
  ...
  private:
    ...
    friend class InputArchive<Microslice, StorableMicroslice, ArchiveType::MicrosliceArchive>;
    friend class InputArchiveLoop<Microslice, StorableMicroslice, ArchiveType::MicrosliceArchive>;
